...
- VS 2017 Build Tools (After opening the installer, **select only** 'Visual C++ Build tools' and install) - [Download](https://aka.ms/vs/15/release/vs_buildtools.exe) (via Microsoft)
